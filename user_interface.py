...
def putwindow():
    ...
    #window.geometry("800x500")
    tkinter.Label(window, text = "^^ FACIAL RECOGNITION ATTENDANCE SYSTEM ^^", fg = "black", bg = "darkorange").pack(fill = "x")
...
def show():
    ...
    tkinter.Label(window2, text = "^^ FACIAL RECOGNITION ATTENDANCE SYSTEM ^^", fg="black", bg="darkorange").pack(fill="x")
...
def show_run():
    ...
    tkinter.Label(window3, text = "^^ FACIAL RECOGNITION ATTENDANCE SYSTEM ^^", fg="black", bg="darkorange").pack(fill="x")
    ...
    tkinter.Label(window3, text = "Enter the gpu memory fraction you want to allocate out of 1").place(x=50, y=200, width=420)
    ...
    tkinter.Label(window3, text="Default values would be assigned to empty fields", fg="navy", bg="lightblue").place(x=700, y=200, width=380)
...
def show_create():
    ...
    tkinter.Label(window4, text = "^^ FACIAL RECOGNITION ATTENDANCE SYSTEM ^^", fg="black", bg="darkorange").pack(fill="x")
    ...
    tkinter.Label(window4, text = "Enter the gpu memory fraction you want to allocate(out of 1)").place(x=50, y=150, width=430)
    ...
    tkinter.Label(window4, text="Default values would be assigned to empty fields", fg="navy", bg="lightblue").place(x=50, y=450, width=380)
    ...
    def submit():
        ...
        '''if rdbtn1.get():
            print('Video')
            #vid_path = '/home/ayushman/Documents/deep_learning/attendance_deep_learning/scripts_used/video/uri1.webm'
...
def show_train():
    ...
    tkinter.Label(window5, text = "^^ FACIAL RECOGNITION ATTENDANCE SYSTEM ^^", fg="black", bg="darkorange").pack(fill="x")
    ...
    tkinter.Label(window5, text = "Enter the gpu memory fraction you want to allocate(out of 1)").place(x=50, y=150, width=430)
...
def show_test():
    ...
    tkinter.Label(window6, text = "^^ FACIAL RECOGNITION ATTENDANCE SYSTEM ^^", fg="black", bg="darkorange").pack(fill="x")
    ...
    tkinter.Label(window6, text="Default values would be assigned to empty fields", fg="navy", bg="lightblue").place(x=60, y=450, width=380)
